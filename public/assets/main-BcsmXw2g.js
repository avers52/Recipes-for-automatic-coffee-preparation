(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=class{constructor(e,t={}){this.parent=e,this.onDelete=t.onDelete||(()=>{}),this.onView=t.onView||(()=>{}),this.onEdit=t.onEdit||(()=>{})}getHTML(e){return`
        ...
        `:`<div class="alert alert-info">Загрузка...</div>`}showError(){let e=document.getElementById(`ingredient-detail-container`);e&&(e.innerHTML=`<div class="alert alert-danger">Ингредиент не найден</div>`)}renderData(){let e=document.getElementById(`ingredient-detail-container`);e&&(e.innerHTML=this.getHTML(),this.addListeners())}addListeners(){document.getElementById(`back-to-list`)?.addEventListener(`click`,()=>{window.location.hash=``,window.location.reload()}),document.getElementById(`delete-ingredient`)?.addEventListener(`click`,async()=>{if(confirm(`Удалить ингредиент "${this.ingredient.name}"?`))try{await t.delete(n.deleteIngredientById(this.ingredientId)),window.location.hash=``}catch(e){console.error(`Ошибка удаления:`,e)}})}render(){this.parent.innerHTML=`<div id="ingredient-detail-container"></div>`,this.loadIngredient()}},i=class{constructor(e){this.parent=e,this.filteredIngredients=[],this.allIngredients=[]}async loadIngredients(){let e=await t.get(n.getIngredients());this.allIngredients=e,this.filteredIngredients=[...this.allIngredients],this.renderIngredients()}async filterIngredients(e){let r=n.getIngredients(e),i=await t.get(r);this.allIngredients=i,this.filteredIngredients=[...this.allIngredients],this.renderIngredients()}async addNewIngredient(){await t.post(n.createIngredient(),{name:`Новый ингредиент`,description:`Введите описание`,image:`https://via.placeholder.com/200`,category:`основной`,unit:`гр`,price:0}),this.loadIngredients()}async deleteIngredient(e){await t.delete(n.deleteIngredientById(e)),this.loadIngredients()}showIngredientDetail(e){new r(this.parent,e).render()}renderIngredients(){let t=document.getElementById(`ingredients-list`);t&&t.remove();let n=document.createElement(`div`);if(n.id=`ingredients-list`,n.className=`ingredients-grid`,this.parent.appendChild(n),this.filteredIngredients.length===0){n.innerHTML=`<div class="alert alert-info">Ингредиенты не найдены</div>`;return}this.filteredIngredients.forEach(t=>{new e(n,{onDelete:e=>this.deleteIngredient(e),onView:e=>this.showIngredientDetail(e),onEdit:e=>window.location.hash=`ingredient-form/edit/${e}`}).render(t)})}render(){this.parent.innerHTML=``;let e=document.createElement(`div`);e.className=`container mt-4`,this.parent.appendChild(e),e.innerHTML=`
